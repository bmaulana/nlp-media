...
TOPICS2 = {'cerebral palsy': ['cerebral palsy', 'spastic'],  # impairment and impaired has the same stem
           'deaf': ['deaf', 'hearing impaired', 'hard of hearing', 'hard-of-hearing', 'hearing loss'],
...
# TODO run experiment for evaluation: everything in TOPICS2 and every source but only 10-20 articles each
...
for tpc, words in TOPICS.items():  # TODO change to TOPICS2 when ready
    fnames = []
    for src in SOURCES:
