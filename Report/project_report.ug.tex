...
Furthermore, the violin plot component show that the Guardian's distribution is more 'compact' around the mean, the Mail has a slightly higher variance of sentiment scores, and the Express has the highest variance of sentiment scores. A version that shows violin plots for each 2-year period was also plotted:
...
Note also that the Daily Express is not plotted for this topic, due to the sample size being too small (128 articles), lower than the moving average window (316 articles on this topic).
