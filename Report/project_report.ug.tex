...
\begin{center}
	\begin{tabu} to 1.0\textwidth { | X[c] | X[c] | X[c] | X[c] | X[c] | }
		...
		\hline
		Mute & 1,516 & 2,273 & 4,746 & 8,535  \\ % todo re-run pipeline for this topic, can't be right
		\hline
		Paralysis & 711 & 4,346 & 3,879 & 8,936  \\
		\hline
		Speech Impairment & 1,777 & 2,994 & 1,357 & 6,128  \\
		\hline
		Total & 48,631 & 132,377 & 124,095 & 305,103  \\ % todo re-calculate after re-running mute 
		\hline
	\end{tabu}
\end{center}
...
\begin{center}
	\begin{tabu} to 1.0\textwidth { | X[c] | X[c] | X[c] | X[c] | X[c] | }
		...
		\hline
		Mute & 24 & 146 & 284 & 454  \\  % todo re-run pipeline for this topic, can't be right
		\hline
		Paralysis & 53 & 1,003 & 405 & 1,461  \\
		\hline
		Speech Impairment & 57 & 73 & 85 & 215  \\
		\hline
		Total & 3,508 & 20,812 & 24,645 & 48,965  \\  % todo re-calculate after re-running mute 
		\hline
	\end{tabu}
\end{center}
