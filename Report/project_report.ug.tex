...
More specifically, in the domain of media representation of particular groups of people, studies such as \cite{waseem2016you} has attempted to use features extracted using NLP (such as $n$-grams and part-of-speech tags) to classify racist and sexist posts in social media.
