...
\usepackage{pdfpages}  % project plan and interim report
...
For each term, a measure of average term occurrence, which measures the expected number of occurrences of a term within any given article for a given source and year, was calculated for each year between 2000 and 2018.
...
\chapter{Evaluation Data and Results}  % appendix A
...
\begin{lstlisting}
{
	"https://content.guardianapis.com/media/2017/nov/30/guardian-wins...": {
		"source": "Guardian",
		"title": "Guardian wins Walkley for film on Bolivian disability ...",
		"datetime": "2017-11-29T21:26:31Z",
		"section": "Media",
		"text": "The Guardian has won a Walkley award for a moving ..."
	}
}
\end{lstlisting}

\newpage
\subsection{After the Feature Extraction Component}

\begin{lstlisting}
{
	"url": "https://content.guardianapis.com/media/2017/nov/30/guardian...",
	"title": "Guardian wins Walkley for film on Bolivian disability ...",
	"datetime": "2017-11-29T21:26:31Z",
	"source": "Guardian",
	"keyword_rank": 5,
	...
	"num_tokens": 262,
	"num_sentences": 27,
	"num_relevant_sentences": 3,
	"relevant_sentences": {
		"Guardian wins Walkley for film on Bolivian disability ...": {
			"keyword_count": 1
		},
		"The Guardian has won a Walkley award for a moving ...": {
			"keyword_count": 1
		},
		"Fighting for a pension: disability rights protesters in ...": {
			"keyword_count": 1
		}
	},
	"keywords_used": {
...
\newpage
\subsection{After the Sentiment Scoring Component}
...
\begin{lstlisting}
{
	...
	"relevance_score_sents": 0.1111111111111111,
	"relevance_score_keyword_rank": 0.2,
...
\includepdf[pages=-]{interim-report.pdf}
