...
This pipeline is then used in an experiment to collect articles from three major British online news publishers and show trends regarding how the terms used and sentiment in news articles varies over time and between different publishers when reporting news related to disability.
...
This was achieved by analysing trends for $n$-gram frequency (a count of words or phrases in a text document) and named entities (known persons, organisations, locations, etc.) in text.
...
The representation of specific groups, such as people with disabilities, in media has been a popular research theme in social science.
...
There were attempts to discover trends, such as a study conducted in 1998 \cite{gold1999media} and replicated in 2008 \cite{devotta2013representations} which assessed change in representations of disability and persons with disability in Canadian news media.
